...
version_prefix = 'dec5b'

min_nodes = 1
max_nodes = 20
nodes_step = 1
schedulers = ['trivial', 'trivial_local', 'trivial_threshold_local', 'transfer_aware', 'transfer_aware_local', 'transfer_aware_threshold_local']
...
trace_single_rlpong = 'traces/sweep/trace_rl-pong_t4_s1.json.gz'
...
def queue_threshold_sweeps():
    ...
    sweep_threshold_queue(schedulers, t1l_range, experiment_name_t1l, trace_single_synmatmul)
    sweep_threshold_queue(schedulers, t1l_range, experiment_name_t1l, trace_single_rnn)
    sweep_threshold_queue(schedulers, t1l_range, experiment_name_t1l, trace_single_rlpong)
