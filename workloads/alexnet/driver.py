...
if __name__ == "__main__":
  ...
  repetitions = args.image_reps
  image_tar_files = ['/mini.00.tar', '/mini.01.tar']
  ...
  filename_label_dict = {'n13133613_9156.JPEG' : 5, 'n13133613_75490.JPEG' : 5, 'n13054560_1334.JPEG' : 7, 'n13054560_3528.JPEG' : 7, 'n13054560_7469.JPEG' : 7}
  ...
  imagenet_data = alexnet.load_tarfiles_from_s3(repetitions, image_tar_files, [256, 256])
