...
parser.add_argument("--iterations", default=5, type=int, help="The number of iterations to run games.")
parser.add_argument("--workers", default=10, type=int, help="The number of Ray workers to be initialized.")
